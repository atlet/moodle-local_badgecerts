...
$string['migrate'] = 'Migrate certificate';
$string['selectcertificate'] = 'Select certificate';
$string['migratesucesfull'] = 'Certificates will be migrated in backgorund. Summary will be visible in logs.';
$string['triedmigrate'] = 'Tried to migrate certificates.';
$string['certcreated'] = 'Certificate sucesfull migrated.';
$string['certerror'] = 'Error migrating certificate.';